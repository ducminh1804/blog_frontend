...
export default function Credit({ icon }: Props) {
  return (
    <div>
      <div className='flex items-center gap-2'>
        <div className='cursor-pointer active:scale-95 transition-all hover:text-blue-800'>{icon}</div>
        <div>
          <img
        ...
        <div className='font-mono text-base'>subreddit name • </div>
        <div className='opacity-60 text-sm'>3 days ago</div>
      </div>
    </div>
  )
}
